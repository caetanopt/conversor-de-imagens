...
| `/icon.png?<versão>` | primeiro carregamento | o ícone da marca, 32×32, 1,2 kB |
| `/marca/fundo-caetano.webp` | primeiro carregamento | a fotografia da marca, fundo da zona de largar, cerca de 100 kB |
